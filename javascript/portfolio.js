const projectCards = [
  {
    card: 1,
    name: 'Design et Développement',
    name2: 'Design et Développement',
    image: 'images/tonic1.svg',
    image2: 'images/Illustration.svg',
    description: `Design et developpement d'un site web`,
    technologies: ['', '',''],
    specifics: ['','', ''],
    specifics2: ['','', ''],
  },
...
serviceSection.innerHTML = projectCards.map((project, index) => `
